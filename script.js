...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function displayUserData(parseData) {
        ...
        const solvedTotalQs = parseData.data.matchedUser.submitStats.acSubmissionNum[0].count;
        const solvedTotalEasyQs = parseData.data.matchedUser.submitStats.acSubmissionNum[1].count;
        const solvedTotalMediumQs = parseData.data.matchedUser.submitStats.acSubmissionNum[2].count;
        const solvedTotalHardQs = parseData.data.matchedUser.submitStats.acSubmissionNum[3].count;

        updateProgress(solvedTotalEasyQs, totalEasyQues, easyLabel, easyProgressCircle);
        updateProgress(solvedTotalMediumQs, totalMediumQues, mediumLabel, mediumProgressCircle);
        updateProgress(solvedTotalHardQs, totalHardQues, hardLabel, hardProgressCircle);
